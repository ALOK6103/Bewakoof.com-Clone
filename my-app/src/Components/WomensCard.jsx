...
let i=0;
const WomensCard=({id,image,title,price})=>{
    ...
    <span >
        <img src={image} alt="pic" style={{height:"300px" , width:"250px" , boxShadow: "rgba(50, 50, 93, 0.25) 0px 2px 5px -1px, rgba(0, 0, 0, 0.3) 0px 1px 3px -1px"  }}  onClick={handleClick} />
